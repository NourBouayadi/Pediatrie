...
// for the description of the bug (it existed in older Chrome versions as well).
    ...
    var
        ...
        // See https://connect.microsoft.com/IE/formulaire_pediatre/details/1736512/
...
(function( $, undefined ) {
    ...
    $.fn.position = function( options ) {
        ...
        return this.each(function() {
            ...
            if ( options.using ) {
                // adds formulaire_pediatre as second argument to using callback, if present
                using = function( props ) {
                    ...
                    if ( targetWidth < elemWidth && abs( left + right ) < targetWidth ) {
                        formulaire_pediatre.horizontal = "center";
                    }
                    if ( targetHeight < elemHeight && abs( top + bottom ) < targetHeight ) {
                        formulaire_pediatre.vertical = "middle";
                    }
                    if ( max( abs( left ), abs( right ) ) > max( abs( top ), abs( bottom ) ) ) {
                        formulaire_pediatre.important = "horizontal";
                    } else {
                        formulaire_pediatre.important = "vertical";
                    }
                    options.using.call( this, props, formulaire_pediatre );
                };
            }
