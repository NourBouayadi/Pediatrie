                ...
                <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h3 col-md-offset-5 mb-0 font-weight-bold text-gray-800"><a
                                                        href="/annuaire"> <?php echo App\User::where("id", "!=", 0)
                                                        ->where("isActive", "=", 1)
                                                        ->where("isPediatre", "=", 1)
                                                        ->count();?></a></div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h3 col-md-offset-5 mb-0 font-weight-bold text-gray-800"><a
                                                        href="/forum"><?php echo App\Discussion::count();?></a></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <tr class="table ">
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <a href="/mail/{{$pediatre->id}}" class="btn btn-secondary"
                                                   aria-hidden="true">
                                                    <i class="fa fa-envelope" aria-hidden="true"></i>
                                                </a>

                                                <a href="{{ action('AdminController@approve', ['id' => $pediatre->id]) }}"
                                                ...
                                                <form action="{{url('dashboard/'.$pediatre->id)}}" method="post"
                                                    ...
                                                    <button type="submit" class="btn btn-danger"
                                                            onclick="return myFunction();"><i class="fa fa-times"
                                                                                              aria-hidden="true"></i>
                                                    </button>
                                                </form>
                    ...
                    <div class="row">
                        ...
                        @foreach($categories as $categorie)
                                <tr class="">
                                    <td rowspan="{{$categorie->num}}">{{$categorie->name}}</td>
                                    <td rowspan="{{$categorie->num}}">{{$categorie->num}} </td>

                                @foreach($moderateurs as $moderateur)
                                    @if($moderateur->categorie_id==$categorie->id)
                                        @if(!$loop->first && $categorie->num > 1)
                                            <tr>
                                                @endif
                                                ...
                                                <td>
                                                    <form action="{{url('/dashboard/delete')}}" method="post"
                                                        ...
                                                        <input type="hidden" name="user_id" value="{{$moderateur->id}}"/>
                                                    </form>
                                                </td>
                                                @if(!$loop->first && $categorie->num > 1)
                                            </tr>
