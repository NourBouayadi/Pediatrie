                ...
                <div class="container">
                    <div class="row">
                        <div class="team-heading text-center col-md-12">
                            ...
                            <div>
                                <div style="color:#3c9dc8;"><h3><a href="/annuaire"> Annuaire des pédiatres Algériens</a></h3></div>
                                <h5 style="text-align:left;"><a href="/"> &lt;&lt; Acuueil</a> &gt; <a href="/annuaire"> Annuaire</a></h5>
                            </div>
                            <br>
                        ...
                        <div class="col-md-12">
                            @foreach($pediatres as $pediatre)
                                    <!--profile-link-->
                                    <div class="col-md-3 single-member col-sm-4 profile-link" style="padding-bottom: 20px;">

                                        <div class="person-detail" id="peds">
                                            <a href="/profile/{{$pediatre->id}}">
                                            <div class="arrow-bottom"></div>
                                            <div style="display: inline-block; text-align: center;"><h4><a
                                                            href="/profile/{{$pediatre->id}}"
                                                            style="color: white; text-align: center;"
                                                            class="col-md-2">{{$pediatre->name}}</a></h4></div>
                                            <br>
                                            <div>
                                             ...
                                             ({{$pediatre->points}})</p>
                                                ...
                                                <b class=""><a href="/profile/{{$pediatre->id}}">>>voir le
                                                        profile</a></b>
            ...
            <form role="search" method="get" action="/annuaire/search">
                <div class="input-group  row" name="search" id="search">
                    <div class="form-group col-md-10">
                        <input type="text" name="name" value="" class="col-md-3 form-control"
                        ...
                        <div class="col-md-3 form-group ">
                            <select name="specialite" id="selectSpecialite" class=" form-control mdb-select">
                                ...
                                <option value="Néonatologie et médecine du nouveau-né">Néonatologie et médecine du
                                    nouveau-né
                                </option>
